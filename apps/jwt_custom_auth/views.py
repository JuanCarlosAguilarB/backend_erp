...
class ObtainTokenView(ObtainUserLoginMiddleware, views.APIView):
    ...
    based on their phone or phone number and the 'JWTAuthentication' class to generate the JWT token
    for the authenticated user.

    Attributes:
        ObtainUserLoginMiddleware (class): The middleware class for user login using phone or phone number.
            It handles user authentication based on the provided phone/phone number and password.
    ...
    Example:
        To use this API view, make a POST request to the view's endpoint with valid phone/phone number
        and password credentials:

        ```
        POST
        {
            "phone": "john_doe@example.com",
    ...
    def post(self, request, *args, **kwargs):
        ...
        phone/phone number and password. If authentication is successful, it generates the JWT token
...
class TokenObtainExtraDetailsView(ObtainUserLoginMiddleware,
    ...
    This API view combines the functionality of the 'ObtainUserLoginMiddleware' to authenticate users
    based on their phone or phone number and the 'TokenObtainPairView' provided by 'rest_framework_simplejwt'
    ...
    def post(self, request, *args, **kwargs):
        ...
        This method uses the 'ObtainUserLoginMiddleware' to authenticate the user based on the provided
        phone/phone number and password. If authentication is successful, it generates the JWT tokens
