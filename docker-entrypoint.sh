...
echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('3194038589', 'Admin12345678#')" | python manage.py shell --settings=core.settings.local
